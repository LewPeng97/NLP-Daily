...
class CommonConfigs(object):
    def __init__(self, d_type):
        ...
        self.TRAINING_DATA_PATH = self.ROOT_PATH + d_type
        self.VALIDATE_DATA_PATH = self.ROOT_PATH + d_type
        self.TESTING_DATA_PATH = self.ROOT_PATH + d_type
...
class DeepmindConfigs():
    ...
    cc = CommonConfigs("lcsts_data/processed_data")
    FIRE = False
